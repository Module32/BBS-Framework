...
module.exports = {
    name: 'configcaptcha',
    help: "Configures whether or not you want CAPTCHA verification in your server.",
    guildOnly: true,
    ...
    execute(message, args) {
        ...
        db.set(`captcha_system_${message.guild.id}`, choice)
        user = message.author
        const welcomeChannelEmbed = new Discord.MessageEmbed()
            .setColor(0x2ECC71)
            .setTitle(`✅   **The captcha has been successfully set to \`${choice}\`.**`)
            .setDescription(`You can also change my \`profanity blockage\` channel and \`welcome channel\`!`)
